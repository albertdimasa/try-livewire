<div>
    <div class="container bg-Wwarning mb-4">
        <h1 class="display-4 element">Hai <b>{{ ucfirst(auth()->user()->name) }}</b></h1>
        ...
        <div class="d-flex gap-3">
            <a href="www.linkedin.com/in/dimas-albert-abraham/" target="_blank">
            ...
            <a href="https://github.com/albertdimasa" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
@push('js')
    {{-- <script>
        var typed = new Typed('.element', {
            strings: ["Hai <b>{{ ucfirst(auth()->user()->name) }}</b>",
